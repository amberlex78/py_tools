...
def move_and_rename_files(path):
    ...
    for filename in files:
        ...
        try:
            ...
            print(f"Moved and renamed file {filename} to folder {new_folder_name} as {new_filename}")
...
if __name__ == "__main__":
    ...
    if not os.path.exists(folder_path):
        ...
        move_and_rename_files(folder_path)
        print("Done!")
